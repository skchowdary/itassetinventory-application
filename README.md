...
To build the final jar and optimize the itassetinventory application for production, run:
...
Then navigate to [http://localhost:8332](http://localhost:8332) in your browser.
